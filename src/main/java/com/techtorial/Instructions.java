...
public class Instructions {
    ...
    public static void getInstructions(int input) {
        ...
        switch (input) {
            case 0:
                System.out.println("Press + 1 - List all items/products, names of products");
                System.out.println("press 2 - Get item/product info (details, availability), price and inventory number");
                System.out.println("");
                System.out.println("");
                System.out.println("");
                System.out.println("");
